...
| 항목 | 내용 |
|------|------|
| **개발 기간** | 2026.01 ~ 2026.07 |
| **역할** | 풀스택 단독 개발 (기획, 프론트엔드, 백엔드, 배포) |
| **상태** | 운영 중 |
| **사이트** | [sasohan.net](https://sasohan.net) |
| **다운로드** | [App Store](https://apps.apple.com/kr/app/id6743611412) · [Google Play](https://play.google.com/store/apps/details?id=com.sasohan.meetings) |
