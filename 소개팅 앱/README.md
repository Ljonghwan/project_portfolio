...
사용자 간의 실시간 매칭과 소통을 중심으로 한 소셜 데이팅 앱입니다. 픽켓 시스템, 음성 통화, 소개팅 일정에 따른 채팅방 테마 변경 등 차별화된 기능을 제공합니다.
...
### 1. 매칭 시스템
- **실시간 플러팅:** 실시간 매칭 알고리즘을 통한 상대방 추천
- **Top 플러팅:** 인기 사용자 우선 노출
...
- **채팅방 관리:** 대화 내용 저장, 차단, 신고 기능

### 3. 프로필 관리
- **프로필 커스터마이징:** 사진, 자기소개, 관심사 등 설정
...
### 5. 소셜 기능
- **스토리:** 24시간 후 사라지는 짧은 콘텐츠 공유
- **피드:** 사용자들의 게시물 피드
- **리뷰 시스템:** 매칭 후 상대방 리뷰 작성

### 6. 결제 & 구독
- **인앱 결제:** react-native-iap를 통한 iOS/Android 인앱 결제
- **정기 구독:** 월간/연간 구독 시스템
- **유료 기능:** 무제한 플러팅, 프로필 우선 노출 등
- **환불 관리:** 결제 내역 및 환불 요청
