...
export default function Component({
    ...
    const dataFunc = async () => {
        ...
        const { data, error } = await API.post('/v1/capsule/finishDay', sender);
        ...
        return (
            <View style={styles.list}>
                ...
                <View style={{ gap: 4, flex: 1 }}>
                    <Text style={styles.name}>{item?.isSelect ? '만남을 수락하셨습니다.' : '만남을 거절하셨습니다.'}</Text>
                    <View style={{ flex: 1 }}>
                ...
                <FlatList
                    ...
                    ListHeaderComponent={
                        <View style={styles.header}>
                            <Text style={[ styles.title ]}>결정의 날</Text>
                            {message && (
                    ...
                    // ListEmptyComponent={
                    //     <Empty msg={room?.dayCount < 4 ? '아직 결정의 날이 아니에요.' : '서로의 만남 의사를 결정할 때까지 기다려 주세요.'} fixed />
                    // }
                />
