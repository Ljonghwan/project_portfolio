...
export default function Page({ item }) {
    ...
    const [flirting, setFlirting] = useState(sendFlirting || 0);
    ...
    const submitAlert = () => {
        ...
        if(accept && flirting > mbData?.flirting) {
        ...
        openAlertFunc({
            ...
            help: mbData?.level === 2 && `*거절 시 탑 플러팅을 수령 할 수 없어요.`,
            onCencleText: "취소",
