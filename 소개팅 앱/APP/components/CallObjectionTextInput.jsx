...
export default function Component({
    ...
    const [ comment, setComment ] = useState(desc || "");
        ...
        >
            ...
            >
                <View style={ styles.titleBox }>
                    <Text style={styles.title}>소명 사유 작성</Text>
                </View>
                <View>
                    <TextArea 
                        iref={iref}
            ...
            <View style={ styles.bottom }>
                ...
                <Button type={1} style={{ flex: 1 }} containerStyle={{ height: 52 }} textStyle={{ fontSize: 16 }} onPress={submitFunc}>확인</Button>
            </View>
        </View>
    );
}
