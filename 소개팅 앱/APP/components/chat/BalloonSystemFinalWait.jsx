    ...
    return (
        <View 
            style={[
                styles.root, 
                { 
                    backgroundColor: isMe ? chatStyle?.chat_season_4?.finalWait : chatStyle?.chat_season_4?.finalWait2,
        ...
        >
            ...
            <View style={{ flex: 1 }}>
                <Text style={{...rootStyle.font(14, isMe ? colors.white : chatStyle?.chat_season_4?.primary, fonts.regular ), letterSpacing: -0.35, lineHeight: 20, textAlign: 'center' }}>{item?.message}</Text>
            </View>
        </View>
    );
}
