...
export default function Component({ item, user }) {
    ...
    return (
        <TouchableOpacity activeOpacity={0.7} style={[styles.buttonBox]} onPress={() => {
            router.navigate({
            ...
            <View style={styles.itemBallonSystem}>
                <View style={[rootStyle.flex, { flex: 1, gap: 8, justifyContent: 'flex-start' }]}>
                    <Image source={images.time_main} style={rootStyle.default20} />
                    <Text style={[styles.itemBallonSystemText, { flexShrink: 1 }]}>{item?.message}</Text>
                </View>
                <Image source={images.link_black} style={rootStyle.default} />
            </View>
