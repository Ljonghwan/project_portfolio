...
export default function Component({ item, users, chatTheme }) {
    ...
    return (
        <AnimatedBackground bg={chatTheme?.systemBackgroundColor} style={[styles.root, { borderColor: chatTheme?.primary }]}>
            ...
            <Image source={chatImages.chat_spring_action} style={rootStyle.default20} transition={200}/>
            ...
            <View>
                ...
                <Text style={{ ...rootStyle.font(12, colors.text_info, fonts.regular ), lineHeight: 20, textAlign: 'center'  }}>• 블라썸 작성을 완료하면 채팅 입력창이 활성화됩니다.</Text>
            </View>
            <TouchableOpacity style={{ width: '100%' }} activeOpacity={1} onPress={() => {
                ...
                <AnimatedBackground bg={chatTheme?.primary} style={styles.button}>
                    ...
                    <Text style={{...rootStyle.font(14, colors.white, fonts.medium )}}>{`블라썸 작성하기`}</Text>
