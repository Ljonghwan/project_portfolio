            ...
            >
                ...
                <TouchableOpacity style={{ gap: 15 }} activeOpacity={0.7} onPress={() => router.push(routes.verification)}>
                    ...
                    <View style={styles.list}>
                        ...
                        {mbData?.rideShare || mbData?.carpool ? (
                            <View style={styles.listData}>
                                <Text style={styles.listText3}>{lang({ id: mbData?.rideShare ? 'ride_share' : 'carpool' })} {lang({ id: 'driver' })}</Text>
                                {/* <Text style={styles.listText3}>{lang({ id: 'drivers_license_5' })}</Text> */}
                                {/* <Text style={styles.listText4}>{lang({ id: 'verified' })}</Text> */}
                            </View>
                        ) : (
                            <View style={styles.listData}>
                    ...
                    {/* 안전운전 인증 완료시 */}
                    <View style={styles.list}>
                        <Text style={styles.label}>{lang({ id: 'driving_record_verify' })}</Text>
                ...
                {(mbData?.carpool || mbData?.rideShare) && (
                    <TouchableOpacity style={{ gap: 15 }} activeOpacity={0.7} onPress={() => router.push(routes.myCar)}>
                        <View style={[rootStyle.flex, { justifyContent: 'space-between' }]}>
                        ...
                        <View style={styles.list}>
                            ...
                            <View style={styles.listData}>
                                <Text style={styles.listText1} numberOfLines={2}>{car?.carType}</Text>
                            </View>
                        </View>
                        <View style={styles.list}>
                            ...
                            <View style={styles.listData}>
                                <Text style={styles.listText1} >{car?.carNumber}</Text>
                            </View>
                        </View>
                    </TouchableOpacity>
                )}
