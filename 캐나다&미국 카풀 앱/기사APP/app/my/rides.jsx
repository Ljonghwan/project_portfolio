...
import { formatCompact, numDoler, numFormat, ToastMessage } from '@/libs/utils';
...
export default function RevenueCard() {
    ...
    const dataFunc = async (reset) => {
        ...
        const { data, error } = await API.post('/v2/my/statSale', sender);
        console.log(data)
        setTimeout(() => {
            if (error) {
                ...
                >
                    ...
                    <View style={styles.header}>
                        <View>
                            ...
                            <View>
                                {load && <Loading entering={false} color={colors.black} style={{ backgroundColor: colors.white, paddingBottom: 0 }} fixed/>}
                                <Text style={styles.totalText}>
                                    {category === 'drive' ? numFormat(total) + " " + lang({ id: 'km' }) : numDoler(total)}
                                </Text>
                            </View>
