...
import { useAlert, usePost } from '@/libs/store';
...
export default function Page() {
    ...
    const submitFunc = () => {
        ...
        openAlertFunc({
            label: lang({ id: 'load_previous_post' }),
            onCencleText: lang({ id: 'no' }),
            onPressText: lang({ id: 'yes' }),
            onCencle: () => { router.push(routes.postWriteForm) },
            onPress: () => { router.push(routes.postWritePrevious)  }
        })
            ...
            <View style={{ flex: 1, backgroundColor: colors.white }}>
                <View style={styles.root}>
                    <View style={{ gap: 11 }}>
                        ...
                        <Text style={styles.subTitle}>{lang({ id: 'please_check_carpool2' })}</Text>
                    </View>
