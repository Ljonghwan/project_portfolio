...
import CouponList from '@/componentsPage/CouponList';
import MileageList from '@/componentsPage/MileageList';
...
const routesTab = [
    { key: 'first', title: lang({ id: 'coupon' }) },
    { key: 'second', title: lang({ id: 'mileage_1' }) },
];
