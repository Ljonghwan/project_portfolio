...
export default function Page() {
    ...
    const { etcImages, setDriverData } = useDriverData();
    ...
    useEffect(() => {
        console.log('etcImages', etcImages?.length);
        setDisabled( !(etcImages?.length > 0));
                ...
                >
                    <View style={styles.root} >
                        ...
                        <View style={{ gap: 13 }}>
                            ...
                            <Text style={styles.subTitle}>{lang({ id: 'can_upload_up' })?.replace("{number}", "3")}</Text>
                            ...
                            <View style={{ gap: 9 }}>
                                <InputFileMulti 
                                    ...
                                    setPhoto={v => {
                                        ...
                                        setDriverData({ key: 'etcImages', value: v })
                                    }}
