...
export default function Page() {
    ...
    const { startDriverType, setDriverData } = useDriverData();
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.white }}>
            <View style={styles.root}>
                <View style={{ gap: 11 }}>
                    <Text style={styles.title}>{lang({ id: 'start_as_driver' })}{presentation}</Text>
                ...
                <View style={{ flex: 1, gap: 19 }}>
                    <Accordion 
                        ...
                        value={level}
                        setValue={setLevel}
                        // disabled={Boolean(startDriverType)}
                    />
                </View>
