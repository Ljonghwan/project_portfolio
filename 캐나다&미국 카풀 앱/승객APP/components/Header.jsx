            ...
            <View style={styles.container}>
                {header?.title && (
                    <View style={[rootStyle.flex, { flex: 1, gap: 2, paddingHorizontal: 60 }]}>
                        <Text numberOfLines={1} style={[styles.header_title, header?.longTitle && { fontSize: 18 }]} >{header?.title}</Text>
                        {header?.subTitle && <Text style={[styles.header_title, header?.longTitle && { fontSize: 18 }]} >{header?.subTitle}</Text>}
                    </View>
                ...
                {header?.right && (
                    ...
                    >
                        ...
                        {header?.right?.text && (
                            <Text style={styles.header_text_button}>{header?.right?.text}</Text>
                        )}
                        {header?.right?.bell && (
                            <Bell />
                        )}
