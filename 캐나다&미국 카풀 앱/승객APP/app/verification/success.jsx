...
export default function Page() {
    ...
    return (
        ...
        >
            ...
            <View style={{ gap: 11 }}>
                <Text style={styles.title}>{lang({ id: type === 'id' ? 'id_verification_requ' : 'completed' })}</Text>
                <Text style={styles.subTitle}>{lang({ id: 'your_request_is' })}</Text>
            </View>
