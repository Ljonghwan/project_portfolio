...
import { Appearance, ActivityIndicator, AppState, AccessibilityInfo, View, Platform, Alert as RNAlert, StyleSheet, Text as RNText, TextInput, Pressable, Modal } from 'react-native';
...
import { getMessaging, registerDeviceForRemoteMessages, getToken, onMessage } from '@react-native-firebase/messaging';
...
export default function RootLayout() {
	...
	useEffect(() => {
		...
		(async () => {
			...
			console.log("foregroundStatus backgroundStatus", Platform.OS, foregroundStatus);
	...
	return (
		<>
			...
			<StripeProvider
				publishableKey={consts.stripeKey}
				urlScheme="taseta"
			>
				<SafeAreaProvider>
