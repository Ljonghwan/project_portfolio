...
export default function Page({ }) {
    ...
    const dataFunc = async () => {
        ...
        const { data, error } = await API.post('/v2/passenger/history/carpoolDetail', sender);
    ...
    const submitFunc = async () => {
        ...
        console.log('sender', sender);
        const { data, error } = await API.post('/v2/passenger/history/sendCarpoolDetail', sender);
            ...
            >
                <View style={{ gap: 13 }}>
                    <View style={styles.list}>
                        ...
                        <Text style={{ ...rootStyle.font(18, colors.main, fonts.medium) }}>{lang({ id: 'passenger' })} - {lang({ id: 'end_ride' })}</Text>
                    </View>
                ...
                <View style={{ gap: 18 }}>
                    ...
                    <View style={{ gap: 15 }}>
                        ...
                        <View style={styles.list}>
                            ...
                            <Text numberOfLines={1} style={styles.content}>{item?.rideInfo?.itinerary?.[0]}</Text>
                        </View>

                        <View style={styles.list}>
                            <Text style={styles.label}>{lang({ id: 'destination' })}</Text>
                            <Text numberOfLines={1} style={styles.content}>{item?.rideInfo?.itinerary?.at(-1)}</Text>
                        </View>
                    ...
                    <View style={{ gap: 15 }}>
                        ...
                        <View style={styles.list}>
                            <Text style={styles.label}>{lang({ id: 'passenger' })} 1</Text>
                        ...
                        {item?.joins?.map((x, i) => {
                            return (
                                <View key={i} style={styles.list}>
                                    <Text style={styles.label}>{lang({ id: 'passenger' })} {i + 2}</Text>
