...
export default function Page() {
    ...
    const { driverType, profile, driveLicence, carImageMain, carImageFront, carImageSide, carImageRear, carNumber, carType, seater, etcImages, setDriverData } = useDriverData();
    ...
    const submitFunc = async () => {
        ...
        const { data, error } = await API.post('/v1/driver/apply', sender);
        ...
        setTimeout(() => {
			...
			router.dismissAll();
			router.replace(routes.joinDriverSuccess)
