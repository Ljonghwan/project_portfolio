	...
	return (
		<View style={styles.root}>
			...
			<Animated.View style={{ gap: 16 }}>
				<View style={{ gap: 8 }}>
					<Text style={{ ...rootStyle.font(20, colors.black, fonts.bold) }}>문의 유형</Text>
				</View>
				<View>
					{configOptions?.feedbackOptions?.map((x, i) => {
						return (
			...
			<View style={[rootStyle.flex, { gap: 4 }]}>
				<Button disabled={disabled} load={load} style={{ flex: 1 }} onPress={() => setValue(selected)}>등록</Button>
			</View>
		</View>
	);
}
