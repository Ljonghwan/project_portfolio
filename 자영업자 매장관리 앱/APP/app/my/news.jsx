...
import News from '@/componentsPage/News';
import ItemChange from '@/componentsPage/ItemChange';
...
export default function Page() {
    ...
    const [index, setIndex] = useState(activeTab ? parseInt(activeTab) : 0);
        ...
        <Layout header={header} >
            <TabView
                ...
                navigationState={{ index, routes: [
                    { key: '1', idx: 1, name: '새소식 (정책)'},
                    { key: '2', idx: 2, name: '원가 변동 알림'}
                ] }}
