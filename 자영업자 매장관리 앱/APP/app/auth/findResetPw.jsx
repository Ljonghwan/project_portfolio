...
export default function Page() {
    ...
    const handleSubmit = async () => {
        ...
        const { data, error } = await API.post('/v1/auth/resetPassword', sender);
        ...
        setTimeout(() => {
			...
			router.replace(routes.findPwResult);
    ...
    return (
        <Layout header={header}>
            ...
            <Pressable style={{ flex: 1, paddingTop: 24, paddingHorizontal: 24, gap: 20 }} onPress={() => {
                Keyboard.dismiss();
            }}>
            ...
            <Button bottom load={load} disabled={disabled} onPress={handleSubmit}>비밀번호 변경</Button>
