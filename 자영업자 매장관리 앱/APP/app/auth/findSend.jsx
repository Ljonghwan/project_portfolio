	...
	return (
		<Layout header={header}>
			<Pressable style={{ flex: 1, paddingTop: 24, paddingHorizontal: 24, gap: 30 }} onPress={() => {
				...
				<Text style={{ ...rootStyle.font(20, colors.text2B2B2B, fonts.bold) }}>휴대폰 번호를 입력해주세요.</Text>
				<TextInput
					iref={iref}
					autoFocus
			...
			<Button bottom disabled={disabled} load={load} onPress={handleNext}>인증번호 요청</Button>
		</Layout>
	);
}
