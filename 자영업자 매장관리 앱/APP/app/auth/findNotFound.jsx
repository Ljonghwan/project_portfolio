...
export default function Login() {
	...
	return (
		<Layout header={{...header, title: type === 'id' ? '아이디 찾기' : type === 'password' ? '비밀번호 찾기' : '' }}>
			<View style={{ flex: 1, paddingBottom: insets?.bottom + 100, paddingHorizontal: 24, gap: 20, justifyContent: 'center', alignItems: 'center' }}>
				...
				<View style={{ gap: 4 }}>
					<Text style={{ ...rootStyle.font(18, colors.black, fonts.semiBold), textAlign: 'center' }}>입력하신 정보로 등록된 회원이 없어요</Text>
					<Text style={{ ...rootStyle.font(14, colors.text7F8287), lineHeight: 32, textAlign: 'center' }}>정보를 다시 확인하고 시도해 주세요.</Text>
				</View>
			</View>
			<Button bottom onPress={() => router.back()}>확인</Button>
		</Layout>
	);
}
