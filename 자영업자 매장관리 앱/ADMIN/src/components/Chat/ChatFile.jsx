...
export default function Chat({ filesValue, setfilesValues }) {
    ...
    return (
        <>
            <label className={styles.chat_input_box_button_text} htmlFor="chat_file">
            ...
            {filesValue?.length > 0 && (
                <div className={`${styles.files_list} ${styles.files_list_full}`}>
                    {filesValue?.map((x, i) => {
                        return (
                            <div key={i}>
