...
import NoticeInfoBox from "@/components/Box/NoticeInfoBox";
...
export default function Cs4() {
    ...
    async function loadData() {
        ...
        setLoad(true);
        const { data, error } = await API.post('/admin/notice/list', sender);
    ...
    return <div className="box">
        ...
        <div className="page_contain">
            ...
            {show &&
                <NoticeInfoBox detail={detail} dataList={dataList} onUpdate={loadData} closeFunc={() => {
                    setShow(false);
                }} />
            }
        </div >
