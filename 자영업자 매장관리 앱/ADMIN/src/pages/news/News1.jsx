...
import NewsInfoBox from "@/components/Box/NewsInfoBox";
...
export default function Cs4() {
    ...
    async function loadData() {
        let sender = {};
        setLoad(true);
        const { data, error } = await API.post('/admin/news/list', sender);
    ...
    return <div className="box">
        ...
        <div className="page_contain">
            ...
            {show &&
                <NewsInfoBox detail={detail} dataList={dataList} onUpdate={loadData} closeFunc={() => {
                    setShow(false);
                }} />
            }
        </div >
