...
export default function InputSelect(props) {
    ...
    return (
        <div className={full ? "input_box input_box_select input_box_full" : "input_box input_box_select"} style={style}>
            {label && <label className={`input_label ${required ? 'required' : ''}`} style={labelStyle} htmlFor={name}>{label}</label>}
            {optionLabel &&
